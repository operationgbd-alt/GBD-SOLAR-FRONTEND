    ...
    try {
      ...
      if (response.success && response.data) {
        const serverInterventions: Intervention[] = response.data.map((serverInt: any) => ({
          ...
          clientName: serverInt.clientName || serverInt.client?.name || '',
          clientAddress: serverInt.clientAddress || serverInt.client?.address || '',
          clientCity: serverInt.clientCity || serverInt.client?.city || '',
          clientPhone: serverInt.clientPhone || serverInt.client?.phone || '',
          clientEmail: serverInt.clientEmail || serverInt.client?.email || '',
          scheduledDate: serverInt.scheduledDate || serverInt.scheduled_date || undefined,
